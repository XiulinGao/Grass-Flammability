...
#assume plant canopy geomerty as a cylinder, calculate diameter for below and above 10cm section

predictmass $ dia10 <- rowMeans(subset(predictmass, select = c(wda10.1, wda10.2, wda10.3, wdb10.1, 
                                                               wdb10.2, wdb10.3)),na.rm = TRUE)

predictmass $ dia <- rowMeans(subset(predictmass, select = c(wda10.3, wda.1, wda.2, wda.3, wdb10.3,
